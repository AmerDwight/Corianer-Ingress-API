...
@Slf4j
public class OracleSqlCommander extends SqlCommander
{

    @Autowired
    private JdbcTemplate jdbcTemplate;

    private final String SQL_COMMAND_PATH_DIRECTORY = "oracle/";

    public OracleSqlCommander(ResourceLoader resourceLoader)
    {
    ...
    public boolean initial()
    {
        ...
        log.info("Initializing Oracle Db database...");
    ...
    protected String loadSql(String fileName) throws IOException
    {
