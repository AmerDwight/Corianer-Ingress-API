...
@Table(name = "ROLE_AUTH_APPLY_DETAIL_HISTORY")
@IdClass(RoleAuthApplyDetailHistoryEntityId.class)
@JsonPropertyOrder({"applyFormId", "apiId", "fabId"})
@JsonIgnoreProperties(value = {"hibernateLazyInitializer", "handler"})
public class RoleAuthApplyDetailHistoryEntity implements Serializable {
    ...
    public static RoleAuthApplyDetailHistoryEntity createFromRealData(RoleAuthApplyDetailEntity realDto){
        RoleAuthApplyDetailHistoryEntity newHisDto = new RoleAuthApplyDetailHistoryEntity();
